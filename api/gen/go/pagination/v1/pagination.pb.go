...
type PagingRequest struct {
	...
	// 排序条件，多个字段使用逗号分隔，asc 表示升序，desc 表示降序。
...
type PagingRequest_Query struct {
	// JSON字符串过滤条件，基础语法：{"field1":"val1", "field2__icontains":"val2"}，具体请参见：https://github.com/alec404/go-crud/tree/main/pagination/filter/README.md
...
const file_pagination_v1_pagination_proto_rawDesc = "" +
	...
	"\bno_total\x18\a \x01(\bB\xb6\x01\xbaG\xb2\x01\x92\x02\xae\x01是否跳过总数统计（COUNT）。为 true 时服务端不计算 total，以提升查询性能；响应中的 total 可能为 0 或不返回（以接口实现为准）。H\aR\anoTotal\x88\x01\x01\x12\xf7\x01\n" +
	"\x05query\x18\n" +
	" \x01(\tB\xde\x01\xbaG\xda\x01:/\x12-{\"field1\":\"val1\", \"field2__icontains\":\"val2\"}\x92\x02\xa5\x01JSON字符串过滤条件，基础语法：{\"key1\":\"val1\",\"key2\":\"val2\"}，具体请参见：https://github.com/alec404/go-crud/tree/main/pagination/filter/README.mdH\x00R\x05query\x12H\n" +
	...
	"filterExpr\x12\x94\x01\n" +
	"\border_by\x18\x14 \x01(\tBt\xbaGq:\x15\x12\x13val1 asc, val2 desc\x92\x02W排序条件，多个字段使用逗号分隔，asc 表示升序，desc 表示降序。H\bR\aorderBy\x88\x01\x01\x12A\n" +
	...
	"tokenBased\x12D\n" +
	"\tno_paging\x18\x04 \x01(\v2\x14.pagination.NoPagingB\x0f\xbaG\f\x92\x02\t不分页H\x00R\bnoPaging\x12\xf7\x01\n" +
	"\x05query\x18\n" +
	" \x01(\tB\xde\x01\xbaG\xda\x01:/\x12-{\"field1\":\"val1\", \"field2__icontains\":\"val2\"}\x92\x02\xa5\x01JSON字符串过滤条件，基础语法：{\"key1\":\"val1\",\"key2\":\"val2\"}，具体请参见：https://github.com/alec404/go-crud/tree/main/pagination/filter/README.mdH\x01R\x05query\x12H\n" +
	...
	"filterExpr\x12\x94\x01\n" +
	"\border_by\x18\x14 \x01(\tBt\xbaGq:\x15\x12\x13val1 asc, val2 desc\x92\x02W排序条件，多个字段使用逗号分隔，asc 表示升序，desc 表示降序。H\x02R\aorderBy\x88\x01\x01\x12A\n" +
	"\asorting\x18\x15 \x03(\v2\x13.pagination.SortingB\x12\xbaG\x0f\x92\x02\f排序规则R\asorting\x12\x8d\x02\n" +
	"\n" +
	...
	"\x02OR\x10\x02B\x9e\x01\n" +
	"\x0ecom.paginationB\x0fPaginationProtoP\x01Z3github.com/alec404/go-crud/api/gen/go/pagination/v1\xa2\x02\x03PXX\xaa\x02\n" +
	"Pagination\xca\x02\n" +
