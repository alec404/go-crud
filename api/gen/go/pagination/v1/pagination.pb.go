...
type PagingRequest struct {
	...
	// AND过滤参数，其语法为json格式的字符串，如：{"key1":"val1","key2":"val2"}，具体请参见：https://github.com/alec404/go-libs/tree/main/entgo/query/README.md
...
const file_pagination_v1_pagination_proto_rawDesc = "" +
	...
	"\asorting\x18\v \x03(\v2\x13.pagination.SortingBH\xbaGE\x92\x02B排序规则（可选，建议必传以保证分页结果稳定）R\asorting\x12\xf6\x01\n" +
	"\x05query\x18\x14 \x01(\tB\xda\x01\xbaG\xd6\x01:\x1f\x12\x1d{\"key1\":\"val1\",\"key2\":\"val2\"}\x92\x02\xb1\x01AND过滤参数，其语法为json格式的字符串，如：{\"key1\":\"val1\",\"key2\":\"val2\"}，具体请参见：https://github.com/alec404/go-libs/tree/main/entgo/query/README.mdH\x06R\x05query\x88\x01\x01\x12P\n" +
	...
	"\asorting\x18\v \x03(\v2\x13.pagination.SortingBH\xbaGE\x92\x02B排序规则（可选，建议必传以保证分页结果稳定）R\asorting\x12\xf8\x01\n" +
	"\x05query\x18\x14 \x01(\tB\xdc\x01\xbaG\xd6\x01:\x1f\x12\x1d{\"key1\":\"val1\",\"key2\":\"val2\"}\x92\x02\xb1\x01AND过滤参数，其语法为json格式的字符串，如：{\"key1\":\"val1\",\"key2\":\"val2\"}，具体请参见：https://github.com/alec404/go-libs/tree/main/entgo/query/README.md\x18\x01H\x01R\x05query\x88\x01\x01\x12R\n" +
